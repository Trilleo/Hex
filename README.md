...
- **Entity highlight** — light up the mobs you care about in a colour you pick, matched by name or by type, with a
  title and a sound the moment a new one turns up.
