...
| One page per feature                                                                                                     | `Config-Profiles`, `Keybind-Shortcuts`, `Control-Switches`, `Attack-Mode-Switch`, `Freecam`, `Mouse-Sensitivity`, `Hand-Display`, `Per-Item-Swing`, `Item-Customization`, `Chroma-Text`, `Titles`, `Reminders`, `Regions`, `Entity-Highlight`, `Notebook`, `Command-Suggestions`, `Languages` |
