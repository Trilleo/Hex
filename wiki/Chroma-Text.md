...
For text there is a second, finer way in. Write **`&z`** in an item's **Name** field, in a [title](Titles), or in a
[note](Notebook), and chroma starts at that point:
...
|------------------|------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| **Chroma speed** | 0.5 – 20 seconds | How long one full trip through the rainbow takes. Lower is faster. Present on all six tabs.                                             |
