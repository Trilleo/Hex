...
- An **installation** property describes *you and your machine*, not a setup. Whether Hex updates itself, which of your
  items you have reskinned, how far into a four-day cookie you are, and which commands you personally type are all in
  this group.

Swapping those on a profile switch would be actively wrong: it would silently turn the updater off, hand your command
history to anyone you shared settings with, and reset a countdown you were relying on. So they stay put.
...
item customizations, and what suggestions has learned.
